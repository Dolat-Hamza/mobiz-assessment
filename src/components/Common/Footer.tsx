            ...
            <Row gutter={[16, 16]}>
                ...
                <Col xs={24} sm={8}>
                    <div className={"flex flex-row gap-4 items-center"}>
                        <p>Connect with Us</p>
                        <Space>
                            <AntdLink href="https://www.facebook.com/yourcompany"
                                      target="_blank"><FacebookFilled/></AntdLink>
                            <AntdLink href="https://www.instagram.com/yourcompany"
                                      target="_blank"><InstagramFilled/></AntdLink>
                            <AntdLink href="https://twitter.com/yourcompany"
                                      target="_blank"><TwitterSquareFilled/></AntdLink>
                        </Space>
                    </div>
                </Col>
            </Row>
